...
export const ListaDeObras= ({datosObras, handleSeleccion}) => {
  return (
    <div className="w-full h-20 bottom-14 md:bottom-0  absolute z-30 flex gap-4 overflow-x-auto justify-center whitespace-nowrap px-6 py-2  bg-red-600/20 scrollbar-hide" >
        {datosObras.map((obra) => (
